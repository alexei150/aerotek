...
@Service
@Transactional
public class CoolerCalculationService implements Calculated {

    private final HeatExchangerSelectionService heatExchangerSelectionService;

    private final SectionRepository sectionRepository;

    public CoolerCalculationService(@Qualifier("coolerSelectionServiceImpl") HeatExchangerSelectionService heatExchangerSelectionService, SectionRepository sectionRepository) {
    ...
    private void calculateFlowParameters(int flowConsumption, List<SectionToConfigurator> flowSections, byte standardSize) {
        ...
        for (SectionToConfigurator sectionToConfigurator : flowSections) {
            if (sectionToConfigurator.getSectionType().getId() == COOLER_ID) {
